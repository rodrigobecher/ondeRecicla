...
export const routes = [
    ...
    {path: '/cadastroEmpresa', name: 'cadastro', component: Cadastro, titulo:'Cadastro Empresa', menu: true},
    {path: '/cadastroEmpresa/:id', name: 'altera', component: Cadastro, titulo:'Cadastro Empresa', menu: false},
